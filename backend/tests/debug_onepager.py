...
def debug_onepager():
    ...
    data_path = f"{root_path}/downloads/NEO/NEO3 - 07&08 - Electricity consumption - 2025-01-01 - 2025-12-31 - 5 minutes.csv"
    loads_summary_path = f"{root_path}/resources/cutoff_dates/NEO3_cutoff_dates.csv"
